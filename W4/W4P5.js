...
let W4P5 = {
    ...
    hasCanvas: true,
    header: "Phong reflections in fragment shader",
    description:
        "Moving the implementation was quite simple, as much of the code could just be copied over with small adjustments to the vertex shader and fragment shader. The following code was moved to the fragment shader:  \n"+
        "```\n"+
        "vec3 H = normalize( L + E );\n"+
        "vec4 ambient = ambientProduct;\n"+
        "float Kd = max( dot(L, N), 0.0 );\n"+
